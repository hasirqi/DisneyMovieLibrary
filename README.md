...
当前 3,466 部主影片中已有 3,406 部具备图片，其中 3,266 部通过 TMDB 电影身份或严格片名＋年份校验取得正式海报，主影片图片覆盖率为 98.3%。主影片厂牌覆盖包括迪士尼动画 112/114、皮克斯 33/34、漫威 39/39、星球大战 40/45、纪录片 18/19、真人电影 785/796、二十世纪影业 2,379/2,419。剩余 60 条主要是未制作/未上映项目、系列合集、年份未知记录，以及没有可靠数字海报的 1930 年代英国短片；它们保留无图状态，不使用相似片名或人物照片冒充海报。

运行 `python3 scripts/repair_catalog_identity.py` 可重建影片身份关系。目前 3,534 条原始档案对应 3,466 部主影片和 68 条同片别名；同年同 TMDB ID 的缩写片名也会自动关联，跨年份 Wikidata/TMDB ID 冲突为 0。
